...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { additional_info: @adress.additional_info, block: @adress.block, number: @adress.number, street: @adress.street } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { additional_info: @adress.additional_info, block: @adress.block, number: @adress.number, street: @adress.street } }
